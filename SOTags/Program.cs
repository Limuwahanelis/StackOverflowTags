...
using (var serviceScope = app.Services.CreateScope())
{
    ...
    {
        APIHelper.SetUP();
        await stackExchangeService.ImportTagsToDB("https://api.stackexchange.com/2.3/tags?page=1&order=desc&sort=popular&site=stackoverflow&filter=!bMsg5CXCu9jto8", context);
